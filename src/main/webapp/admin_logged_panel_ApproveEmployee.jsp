...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			<li >
				<a href="admin_logged_panel.jsp">
					<i class='bx bxs-dashboard' ></i>
					<span class="text">Dashboard</span>
				</a>
			</li>
			<li>
                            <a href="admin_logged_panel_MyProfile.jsp" id="clickProfile">
			...
			<li>
				<a href="admin_logged_panel_ViewEmployee.jsp">
					<i class='bx bxs-message-dots' ></i>
					<span class="text">View Employee</span>
				</a>
			</li>
			<li class="active">
				<a href="admin_logged_panel_ApproveEmployee.jsp">
		...
		<ul class="side-menu">
			<li>
				<a href="admin-login.jsp" class="logout">
       ...
       out.println("<th></th>");
        ...
        while (rs.next()) {
            ...
            out.println("<tr>");
             ...
             out.println("<td><input type=\"checkbox\" onclick=\"checkboxClicked(this, '" + value + "')\"></td>"); 
            out.println("<td>" + rs.getString(1) + "</td>");
            out.println("<td>" + rs.getString(2) + "</td>");
            out.println("<td>" + rs.getString(3) + "</td>");
        
            // Add more columns based on your table structure
          //  out.println("<td><button style=\"padding:5px;background-color:blue;color:white; margin-left:5px;border-radius:5px;cursor:pointer;\"><a style=\"text-decoration:none\" value=\"value\" href=\"deleteRow.jsp\">Delete</a></button></td>");
           out.println("<td><a style=\"text-decoration:none; padding:5px;background-color:blue;color:white; margin-left:15px;border-radius:5px;cursor:pointer;\" href=\"ApproveAdminWithHR.jsp?empid=" + rs.getString(1) + "\">Approve</a></td>");
            out.println("</tr>");
                     }
