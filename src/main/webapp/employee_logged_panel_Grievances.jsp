...
.add-grievance {
    ...
    .add-grievance form label {
        display: block;
        margin-bottom: 5px;
        color: var(--dark);
    }

    .add-grievance form input[type="text"],
    .add-grievance form textarea {
        width: 100%;
        padding: 8px;
        margin-bottom: 10px;
    ...
    .add-grievance form input[type="submit"] {
    ...
    .add-grievance form input[type="submit"]:hover {
...
<body>
	...
	<section id="content">
		...
		<main>
			...
			<div class="add-grievance">
        <h2>Add New Grievance</h2>
        <form id="addGrievanceForm">
            <label for="grievanceSubject">Subject:</label>
            <input type="text" id="grievanceSubject" required><br>

            <label for="grievanceDetails">Details:</label>
            <textarea id="grievanceDetails" rows="4" required></textarea><br>
	...
	<!-- CONTENT -->
        ...
        <script>
        const addGrievanceForm = document.getElementById('addGrievanceForm');
        addGrievanceForm.addEventListener('submit', function (e) {
            e.preventDefault();
            ...
            const url = 'GrievanceServlet'; // The URL of your Java Servlet
            const data = `grievanceSubject=${encodeURIComponent(subject)}&grievanceDetails=${encodeURIComponent(details)}`;
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        ...
                        addGrievanceForm.reset();
                    } else {
                        // Error, handle the error and display an error message
                        console.error('Error submitting grievance:', xhr.responseText);
                    }
                }
            };
