...
<body>
  <%-- Add the content of the JSP page --%>
  <%@include file="header.jsp" %>
  <div class="container">
    <h2>Admin Login</h2>
 
    <form method="post" action="validateAdminLogin.jsp">
  ...
  <a href="admin-reg.jsp" style="display: inline; width: 20px; background-color: navy;color: white;text-decoration: none;padding: 5px;">Register here</a>
</div>
